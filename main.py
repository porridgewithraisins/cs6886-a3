...
def main():
    ...
    for epoch in range(epochs):
        ...
        for x, y in loop:
            ...
            total += y.size(0)
            loop.set_postfix(train_acc=100*running_correct/total,
        ...
        print(f"[{now()}] Epoch {epoch+1}: Val Acc={val_acc*100:.2f}%, Val Loss={val_loss:.4f}")
        slog_writer.writerow([epoch+1, train_loss_epoch, train_acc_epoch, val_loss, val_acc])
